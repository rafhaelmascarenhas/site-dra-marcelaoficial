...
import { cn } from "../../lib/utils"; // Ajustado o caminho para cn
...
export function StarButton({
  ...
  return (
    ...
    >
      ...
      <span className="z-10 relative bg-gradient-to-t from-[#D4AF37] to-[#F9F8F6] inline-block text-transparent bg-clip-text">
        {children}
      </span>
    </button>
  );
